...
**Users ve order** bilgileri için **WooCommerce REST API**, **product** bilgileri için ise WooCommerce Ürün sekmesi kullanılarak WooCommerce aracılığıyla ithal edildi.

**R Api Script kodları adresi:**

- `donemproje1_fecriati/Fecriati/R/Order_Script_Api.R`
- `donemproje1_fecriati/Fecriati/R/Users_Script_Api.R`
